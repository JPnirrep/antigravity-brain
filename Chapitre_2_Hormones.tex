...
Le nerf vague, ce lien mystérieux entre notre cerveau et nos viscères, est le premier impacté par le manque d'affirmation. Lorsque nous nous taisons par peur, nous envoyons un signal de danger à notre système digestif. Le "nœud à l'estomac" n'est pas une image littéraire, c'est une réalité neurologique. Le flux sanguin est détourné du système digestif pour alimenter les muscles de la fuite. À long terme, cette privation de ressources crée des désordres fonctionnels chroniques que la médecine peine parfois à nommer.

\section{La Fatigue de l'Indifférence à Soi}
S'affirmer demande de l'énergie, mais \textit{ne pas} s'affirmer en demande dix fois plus. C'est le paradoxe de l'inhibition. Porter un masque de soumission toute la journée est un effort herculéen qui vide les batteries mitochondriales. La fatigue que ressentent les personnes non-assertives n'est pas une fatigue de mouvement, c'est une fatigue de contention.
